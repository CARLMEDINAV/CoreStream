#!/usr/bin/env python3
"""
Script para configurar la base de datos de CoreStream
Crea aplicaciones y épicas de ejemplo para probar el drag & drop
"""
...
async def setup_database():
    ...
    async with async_session() as session:
        ...
        print("\n🔗 URLs para probar:")
        for app in apps:
            print(f"  • Constructor: http://localhost:5173/admin/builder?appId={app.id}")
        
        print("\n✅ Base de datos configurada exitosamente!")
        print("🚀 Ahora puedes probar el drag & drop en el constructor")
